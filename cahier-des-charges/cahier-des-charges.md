...
|----------|:-------:|-------:|------:|
| 38 | Mise en place de la VM de développement | Mise en place de la VM de développement |
| 39 | Rédaction sur la documentation | Rédaction sur la documentation |
| 40 | Apprentissage Django | Apprentissage Scratch Jr |
| 41 | Apprentissage Django | Développement des fonctionnalités de base |
| 42 | Mise en place du projet Django (base de données, recherche de librairies complémentaires) | Développement des fonctionnalités de base |
| 43 | Gestion des utilisateurs et back-office | Développement des fonctionnalités de base |
| 44 | Front-end design | Développement des fonctionnalités de base |
| 45 | Front-end design | Développement des fonctionnalités de base |
| 46 | Gestion des projets (création, mise à jour, etc...) | Gestion des projets (création, mise à jour, etc...) |
| 47 | Ecriture de tests, mise en place des tests | Ecriture de tests, mise en place des tests |
| 48 | Débogage, peaufinage | Débogage, peaufinage |
| 49 | Rédaction rapport | Rédaction rapport |
| 50 | Rendu rapport + mise en place du planning pour les prochaines sessions | Rendu rapport + mise en place du planning pour les prochaines sessions |
| 51 |  |  |
| 52 |  |  |
| 01 |  |  |
| 02 |  |  |
